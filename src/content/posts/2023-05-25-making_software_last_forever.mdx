...
<span className='text-sm'>
	(Photo by Deborah Feingold/Corbis via Getty Images) This was the release of Windows 1.0. The
	beginning. Computers evolve. The underlying hardware, CPU, memory, and storage evolves. The
	operating system evolves. Of course, the software we use must evolve as well.
</span>
