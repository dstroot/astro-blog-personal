...
<span className="text-sm">
  (Photo by Jason Andrew for The New York Times) After spending nearly a year
  investigating the Jan. 6, 2021 attack on the U.S. Capitol, the House select
  committee that was tasked with scrutinizing the riot is holding a series of
  public hearings.
</span>
